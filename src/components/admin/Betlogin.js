...
class Betlogin extends Component {
  ...
  barList() {
    this.props.changeTitle({ left: <div><i className="fas fa-futbol"></i> HULK BET</div>, center: 'Contas Bet 365', right: <button type="button" onClick={this.newData.bind(this)} className="btn-right">Novo</button> });
  }
  barForm = () => {
    ...
    return (
      <React.Fragment>
        ...
        <div id="list" className="div-table">
          <table className="table table-light table-hover table-bordered table-striped table-sm text-center" >
            <thead>
              <tr>

...
class Parameter extends Component {
  ...
  barList() {
    this.props.changeTitle({ left: <div><i className="fas fa-plane"></i> BetPoint</div>, center: 'Parametros', right: <button type="button" onClick={this.newData.bind(this)} className="btn-right">Novo</button> });
  }
  barForm = () => {
